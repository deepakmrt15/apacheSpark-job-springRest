package com.ds.spring.spark.example.models;
...
@Table(name = "trx_rec")
@Entity
public class TrxInfoRecord implements Serializable {
    ...
    public TrxInfoRecord() {

    }

    public TrxInfoRecord(Long id, Long referenceId, Long requested, Long processed, Integer type, Integer tranCurrency, BigDecimal tranAmount, String merchantTransactionId, String merchantTransactionReference, UUID uuid, UUID channelId, UUID merchantId, long shortId, Long bindingSnapshotId, String invoiceId, String shopperId) {
        this.id = id;
    ...
    public TrxInfoRecord(UUID channelId, UUID merchantId, Long referenceTransaction,
